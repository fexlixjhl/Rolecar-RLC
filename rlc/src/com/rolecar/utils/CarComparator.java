	...
	public int compare(Object o1, Object o2) 
	{
		...
		try
		{
			...
			switch(orden)
			{
				...
				case 1:
					//precioc1S = Formatea.preciomasbajo(c1);//c1.getQuote().getTotalRateEstimateInBookingCurrency();
					//precioc2S = c2.getQuote().getTotalRateEstimateInBookingCurrency();
					precioc1 = Formatea.preciomasbajo(c1);//new Float(precioc1S);
					precioc2 = Formatea.preciomasbajo(c2);//new Float(precioc2S);
					precioc1S = precioc1.toString();
					precioc2S = precioc2.toString();
				...
				case 2:
					...
					//precioc2S = c2.getQuote().getTotalRateEstimateInBookingCurrency();
					precioc1 = Formatea.preciomasbajo(c1);//new Float(precioc1S);
					precioc2 = Formatea.preciomasbajo(c2);//new Float(precioc2S);ç
					precioc1S = precioc1.toString();
					precioc2S = precioc2.toString();
