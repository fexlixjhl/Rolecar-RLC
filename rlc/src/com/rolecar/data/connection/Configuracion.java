...
public class Configuracion
{
	  Properties properties = null;
	    ...
	    public final static String CONFIG_FILE_NAME2 = "config.properties";
	    ...
	    private Configuracion()
	    {
	        ...
	        try
	        {
	            ...
	            properties.load(Configuracion.class.getClassLoader().getResourceAsStream(CONFIG_FILE_NAME2));
