...
<link rel="stylesheet" href="stylesheets/busqueda.css" type="text/css"
	media="screen">
...
<div class="page">
	<div class="page-content">
		<div class="page-content-section">
			<div class="grid-row">
				<!-- feedback -->
				<form action="contacts-action.php" method="post" id="block-feedback"
					class="block block-feedback">
					<div id="tvhiculo">
						<input type="radio" id="tvhiculo1" name="tvhiculo"
							checked="checked" value="CR"><label for="tvhiculo1">
							<fmt:message key="busqueda.coches" />
						</label> <input type="radio" id="tvhiculo2" name="tvhiculo" value="TR"><label
							for="tvhiculo2"><fmt:message key="busqueda.furgonetas" /></label>
					</div>
							...
							<div id="Campos">
								<div class="input">
									<input id="station" name="station" type="text"
										placeholder="<fmt:message key='busqueda.station.text'/>" /> <input
										type="hidden" id="stationid" name="stationid" />

								</div>
								<div class="campoleft oculta">
									<input id="stationOrig" name="stationOrig" type="text"
										placeholder="<fmt:message key='busqueda.stationOrig.text'/>" />
									<input type="hidden" id="stationOrigid" name="stationOrigid" />
								</div>
								<div class="campoleft oculta">
									<input id="stationDest" name="stationDest" type="text"
										placeholder="<fmt:message key='busqueda.stationDest.text'/>" />
									<input type="hidden" id="stationDestid" name="stationDestid" />
								</div>
								<div class="inputFecIcon">

									<span id="fechainicial" class="input-group"><i
										class="fa fa-calendar fa-fw"></i></span>
								</div>
								<div class="inputFec">
									<input id="fini" name="fini" type="text" readonly>
								</div>
								<div class="inputFecIcon">

									<span id="horainicial" class="input-group"><i
										class="fa fa-clock-o fa-fw"></i></span>
								</div>
								<div class="inputSinBorde">
								...
								<div class="inputFecIcon">
									<span id="fechafinal" class="input-group"><i
										class="fa fa-calendar fa-fw"></i></span>
								</div>
								<div class="inputFec">
									<input id="ffin" name="ffin" type="text" readonly />
								</div>
								<div class="inputFecIcon">
									<span id="horafinal" class="input-group"><i
										class="fa fa-clock-o fa-fw"></i></span>
								</div>
								<div class="inputSinBorde">
					...
					<div id="tsucursal" style="">
						<input type="radio" id="tsucursal1" name="tsucursal"
							checked="checked" value="tsucursal1">
							<label
							for="tsucursal1"><fmt:message
								key="busqueda.misma.oficina" /></label> <input type="radio"
							id="tsucursal2" name="tsucursal" value="tsucursal2"><label
							for="tsucursal2"><fmt:message
								key="busqueda.distinta.oficina" /></label>
...
<div class="publicidad">
	<div class="oneByOne1" style="overflow: hidden;">
		<div id="obo_slider" style="left: 0px;">
			<div id="buscador" class="oneByOne_item"
				style="display: block; left: 0px;">
				<img class="wp1_3 slide1_bot animate0 rotateInUpLeft" alt=""
					src="images/50001.png" width="auto" height="270px"> <br
					class="animate1 rotateInUpLeft"> <span
					class="txt1 animate2 rotateInUpLeft"><fmt:message
						key="busqueda.rotate.text1" /></span> <br
					class="animate3 rotateInUpLeft"> <span
					class="txt2 animate4 rotateInUpLeft"><fmt:message
						key="busqueda.rotate.text2" /></span> <br
					class="animate5 rotateInUpLeft"> <span
					class="txt3 short animate6 rotateInUpLeft"><fmt:message
						key="busqueda.rotate.text3" /></span> <br
					class="animate7 rotateInUpLeft">
			...
			<div class="grid-row">
				...
				<div class="block block-about">
					<div class="block-head block-head-2">
						<fmt:message key="busqueda.msj.adapta" />
						<i></i>
					</div>
					<div class="block-cont">
						<h2>
						...
						<p>
							<fmt:message key="busqueda.msj.descuento" />
							.
							<fmt:message key="busqueda.msj.negocio" />
						</p>
						<a href="modelonegocio.jsp" class="button"><fmt:message
								key="comun.leer" /></a>
